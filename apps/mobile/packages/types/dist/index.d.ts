...
export declare enum PrimaryGoal {
...
export declare enum HealthPlatform {
...
export declare enum HealthConnectionStatus {
    CONNECTED = "CONNECTED",
...
export declare enum MealStatus {
    UPCOMING = "UPCOMING",
    IN_PROGRESS = "IN_PROGRESS",
    COMPLETED = "COMPLETED",
    PARTIAL = "PARTIAL",
...
export declare enum CardioType {
    RUNNING = "RUNNING",
    WALKING = "WALKING",
    CYCLING = "CYCLING",
...
export declare enum HeartRateZone {
    ...
    ZONE_5_ANAEROBIC = "ZONE_5_ANAEROBIC"
}
...
export declare enum BodyMeasurementType {
    WAIST = "WAIST",
    CHEST = "CHEST",
    HIPS = "HIPS",
    NECK = "NECK",
...
export declare enum BMICategory {
...
export declare enum AIInsightType {
...
export type ReportType = 'CLIENT_PROGRESS' | 'WORKOUT_ADHERENCE' | 'NUTRITION_ADHERENCE' | 'COACH_PERFORMANCE' | 'ORGANIZATION_SUMMARY' | 'ORGANIZATION_OVERVIEW' | 'PROGRAM_PERFORMANCE';
export type CalendarEventType = 'PLANNED_WORKOUT' | 'COMPLETED_WORKOUT' | 'MISSED_WORKOUT' | 'REST_DAY' | 'CARDIO_SESSION' | 'CHECKIN' | 'NUTRITION_START';
...
export type CoachAiDraftType = 'PERFORMANCE_SUMMARY' | 'WORKOUT_ADJUSTMENT' | 'NUTRITION_ADJUSTMENT' | 'CHECKIN_MESSAGE';
...
export type QueueName = 'NOTIFICATIONS_DISPATCH' | 'REMINDERS_SCHEDULE' | 'AUTOMATIONS_EVALUATE' | 'WEEKLY_DIGEST' | 'DAILY_ANALYTICS_AGGREGATION' | 'WEEKLY_ANALYTICS_AGGREGATION' | 'CLIENT_SUMMARY_REFRESH' | 'ORGANIZATION_SUMMARY_REFRESH' | 'HEALTH_INITIAL_SYNC' | 'HEALTH_INCREMENTAL_SYNC' | 'WEARABLE_SYNC' | 'SYNC_RETRY' | 'TOKEN_REFRESH';
...
export type AutomationEventType = 'WORKOUT_COMPLETED' | 'MISSED_WORKOUT' | 'PR_ACHIEVED' | 'MEAL_LOGGED' | 'DAILY_MACROS_MET' | 'STEP_MILESTONE' | 'STREAK_PRESERVED' | 'PROGRAM_ASSIGNED' | 'MEAL_PLAN_ASSIGNED' | 'COACH_MESSAGE_SENT' | 'AI_INSIGHT_AVAILABLE';
...
export type KPICategory = 'USER' | 'COACH' | 'ORGANIZATION' | 'WORKOUT' | 'NUTRITION' | 'ACTIVITY' | 'PROGRESS' | 'ENGAGEMENT';
export type KPIUnit = 'PERCENTAGE' | 'COUNT' | 'MINUTES' | 'KG' | 'STEPS' | 'DAYS' | 'RATIO';
export type DataFreshness = 'LIVE' | 'RECENT' | 'PROCESSING' | 'STALE' | 'UNAVAILABLE';
export type AnalyticsScope = 'CLIENT' | 'COACH' | 'ORGANIZATION';
export type AnalyticsTimePeriod = 'TODAY' | '7_DAYS' | '30_DAYS' | '90_DAYS' | '6_MONTHS' | '12_MONTHS' | 'CUSTOM';
...
export declare enum EnterprisePermission {
...
export declare enum SecurityAuditEventType {
...
export type RetentionCategory = 'RAW_TELEMETRY' | 'ANALYTICS_AGGREGATES' | 'SENSITIVE_PHOTOS' | 'AUDIT_LOGS' | 'INACTIVE_ACCOUNTS';
...
export declare enum IntegrationConnectionState {
    AVAILABLE = "AVAILABLE",
...
export declare enum HealthPermissionState {
...
export declare enum IntegrationAuthType {
    OAUTH2 = "OAUTH2",
...
export type ConflictResolutionStrategy = 'MANUAL_OVERRIDE' | 'HIGHER_CONFIDENCE' | 'LATEST_TIMESTAMP' | 'MAX_VALUE';
...
export declare enum TokenRefreshStatus {
